...
<div class="weather-widget">
    ...
    <table>
        ...
        <td>
            <h5 class="condition row">${weatherDtoList[7].clouds}</h5>
            <h5 class="condition row">${weatherDtoList[7].pop}</h5>
            <h5 class="condition row">${weatherDtoList[7].pressure}</h5>
            <h5 class="condition row">${weatherDtoList[7].relativeHumidity}</h5>
            <h5 class="condition row">${weatherDtoList[7].windDirection}</h5>
            <h5 class="condition row">${weatherDtoList[7].windSpeed}</h5>
        </td>
    </table>
    <div class="Excel">
